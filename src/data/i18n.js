...
export const translations = {
  id: {
    ...
    common: {
      ...
      media: "Media",
      performanceTeam: "Di Atas Panggung",
      artisticOps: "Keberagaman Penampil",
    ...
    organization: {
      ...
      body: "Susunan ini memuat koordinator majelis serta keberagaman penampil utama: dalang, hadroh, barzanji, dan sinden.",
      teamNote: "Keberagaman penampil utama dalam pementasan Majelis Seni Nyawiji.",
      leaderLabels: ["Koordinator 1", "Koordinator 2"],
      leaderRoles: ["", ""],
      leaderNotes: [
        "Perancang program, kemitraan, dan kolaborasi.",
        "Koordinator program, agenda pementasan, dan komunikasi lintas tim.",
      ],
      performanceMembers: [
    ...
    gallery: {
      ...
      publicationKicker: "Berita Terbaru",
  ...
  en: {
    ...
    common: {
      ...
      media: "Media",
      performanceTeam: "On Stage",
      artisticOps: "Diverse Performers",
    ...
    organization: {
      ...
      body: "This structure introduces the ensemble coordinators and the diverse main performers: dalang, hadroh, barzanji, and sinden.",
      teamNote: "Diverse main performers in Majelis Seni Nyawiji performances.",
      leaderLabels: ["Coordinator 1", "Coordinator 2"],
      leaderRoles: ["", ""],
      leaderNotes: [
        "Designs programs, partnerships, and collaboration.",
        "Coordinates programs, performance agendas, and cross-team communication.",
      ],
      performanceMembers: [
        ["Dalang", "Ahmad Nafis Jauhari", "Pakeliran"],
